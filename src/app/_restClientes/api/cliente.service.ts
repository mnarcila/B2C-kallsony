...
/**manito */
    public consultarClienteCredencial(headerRq: string, serviceID: string, usuario: string, clave: string, observe?: 'body', reportProgress?: boolean): Observable<ClienteRsType>;
    public consultarClienteCredencial(headerRq: string, serviceID: string, usuario: string, clave: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ClienteRsType>>;
    public consultarClienteCredencial(headerRq: string, serviceID: string, usuario: string, clave: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ClienteRsType>>;
    public consultarClienteCredencial(headerRq: string, serviceID: string, usuario: string, clave: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
        ...
        return this.httpClient.get<ClienteRsType>(`${this.basePath}/consultarClienteCredenciales/${encodeURIComponent(String(usuario))}/${encodeURIComponent(String(clave))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
